...
extern const char* audio_queue_synchronization_notification;
extern const char* audio_queue_flush_notification;
...
uint32_t audio_queue_add_packet(audio_queue_p aq, void* encoded_buffer, size_t encoded_buffer_size, int32_t seq_no, uint32_t sample_time);
